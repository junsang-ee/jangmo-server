...
public enum ErrorMessage {
    ...
    AUTH_INVALID(4001, HttpStatus.UNAUTHORIZED),
    AUTH_PASSWORD_INVALID(4002, HttpStatus.UNAUTHORIZED),
    AUTH_DISABLED(4003, HttpStatus.FORBIDDEN),
    AUTH_UNAUTHENTICATED(4004, HttpStatus.FORBIDDEN),
    AUTH_RETIRED(4005, HttpStatus.FORBIDDEN),
    AUTH_ALREADY_ENABLED(4006, HttpStatus.BAD_REQUEST),
    AUTH_MERCENARY_CODE_INVALID(4007, HttpStatus.BAD_REQUEST),
    AUTH_MERCENARY_EXPIRED(4008, HttpStatus.BAD_REQUEST),
    AUTH_MERCENARY_PRIVACY(4009, HttpStatus.BAD_REQUEST),
    AUTH_CODE_INVALID(4020, HttpStatus.BAD_REQUEST),
    AUTH_CODE_EXPIRED(4021, HttpStatus.GONE),
