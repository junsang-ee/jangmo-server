...
public enum ErrorMessage {
    ...
    AUTH_PASSWORD_INVALID(4000, HttpStatus.UNAUTHORIZED),
    AUTH_DISABLED(4001, HttpStatus.FORBIDDEN),
    AUTH_UNAUTHENTICATED(4002, HttpStatus.FORBIDDEN),
    AUTH_RETIRED(4003, HttpStatus.FORBIDDEN),
    AUTH_ALREADY_ENABLED(4004, HttpStatus.BAD_REQUEST),
    AUTH_MERCENARY_CODE_INVALID(4005, HttpStatus.BAD_REQUEST),
    AUTH_MERCENARY_EXPIRED(4006, HttpStatus.BAD_REQUEST),
    AUTH_MERCENARY_PRIVACY(4007, HttpStatus.BAD_REQUEST),
    AUTH_CODE_INVALID(4010, HttpStatus.BAD_REQUEST),
    AUTH_CODE_EXPIRED(4011, HttpStatus.GONE),
    ...
    MERCENARY_CODE_NOT_FOUND(5003, HttpStatus.NOT_FOUND),
    ...
    MERCENARY_ALREADY_TRANSIENT_EXISTS(6012, HttpStatus.BAD_REQUEST),
