...
public enum ErrorMessage {
    ...
    MERCENARY_CODE_NOT_FOUND("5002"),

    MEMBER_ALREADY_ENABLED("6000"),
    MERCENARY_ALREADY_ENABLED("6001"),
    MERCENARY_ALREADY_CODE_EXISTS("6002"),
    MERCENARY_NEEDS_CODE_REISSUE("6003"),
    MERCENARY_NEEDS_STATUS("6004"),
    UNKNOWN("9999");
