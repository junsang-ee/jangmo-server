...
public class AuthController {
	...
	public ResponseEntity<ApiSuccessResponse<MemberSignupResponse>> signupMember(
		@Valid @RequestBody MemberSignUpRequest signup
	) {
		return wrap(authService.signupMember(signup));
	}

	@PostMapping("/register/mercenary")
	public ResponseEntity<ApiSuccessResponse<MercenaryRegistrationResponse>> registerMercenary(
		@RequestBody MercenaryRegistrationRequest registration
	) {
